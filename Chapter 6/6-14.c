...
void median(unsigned int answer[])
{
   ...
   printf("\n\nThe median is element %u of\n"
           ...
           SIZE / 2, SIZE, answer[((SIZE / 2) + ( SIZE / 2 + 1)) / 2]);
} 
...
void mode(unsigned int freq[], const unsigned int answer[])
{
   ...
   // output results
   unsigned int largest = 0, largest1 = 0; // represents largest frequency
   unsigned int modeValue = 0, modeValue1 = 0; // represents most frequent response
   ...
   printf("For this run the mode is ");
   
   if (	largest1 = largest )
   {
   		printf("%d, %d", modeValue, modeValue1);
